...
// Project paths
var project     = 'layout',                // The directory name for your theme; change this at the very least!
  ...
  scripts: {
    ...
    chunks: { // Chunks are arrays of paths or globs matching a set of source files; this way you can organize a bunch of scripts that go together into pieces that can then be bundled (above)
      ...
      footer: [
        ...
        bower+"scrollmagic/scrollmagic/minified/ScrollMagic.min.js",
        bower+"scrollmagic/scrollmagic/minified/plugins/debug.addIndicators.min.js",
        bower+"scrollmagic/scrollmagic/minified/plugins/animation.gsap.min.js",
        modules+'timeago/jquery.timeago.js', // The modules directory contains packages downloaded via npm
        src+'js/partials/TweenMax.min.js',
        src+'js/partials/MorphSVGPlugin.min.js',
        src+'js/partials/slick.js',
        src+'js/partials/motion.js',
        src+'js/partials/single.js',
        src+'js/partials/jquery.fancybox.min.js',
        src+'js/partials/jquery.hover3d.min.js',
        src+'js/partials/jquery.youtubebackground.js',
